...
public class ExpActivity extends AppCompatActivity {
    ...
    public void initView() {
        ...
        ActionBarDrawerToggle mDrawerToggle = new android.support.v7.app.ActionBarDrawerToggle(this, mDrawerLayout, mToolbar, R.string.drawer_open, R.string.drawer_close);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.item_two:
                        ...
                        intent2.setClass(ExpActivity.this,Location_edit.class);
                        startActivity(intent2);
                        break;
                    case R.id.item_three:
                        Log.i("TAG", "你已经是快递员了");
                        Toast.makeText(ExpActivity.this, "你已经是快递员了", Toast.LENGTH_LONG).show();
                        break;
                }
