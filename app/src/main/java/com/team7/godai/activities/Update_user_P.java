 ...
 */
public class Update_user_P extends AppCompatActivity {

    Toolbar mToolbar;
    Update_user_P update_user_p;
    TextView gender;
    TextView password;
    TextView phone;
    TextView school;
                ...
                new AlertDialog.Builder(update_user_p)
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                intent.setClass(Update_user_P.this, User_edit_P.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            Intent intent = new Intent();
            intent.setClass(Update_user_P.this, PubActivity.class);
            startActivity(intent);
            this.finish();
            return true;
        }
